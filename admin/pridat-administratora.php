  ...
  <body>
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" href="smazat-uzivatele.php"><img alt="Brand" src="images/main.png"></a>
    ...
    <div class="container-fluid">
      <div id="content">
        ...
        <?php if(isset($_SESSION['admin_email'])) echo 'baaaaa'; ?>
          ...
          <div class="col-xs-12 col-sm-8">
            <div class="panel panel-default">
              ...
              <div id="user-details">
                ...
                <button type="button" class="btn btn-primary" id="login-button">Smazat</button>
              </div> <!-- #user-details -->
            </div> <!-- panel-heading-->
