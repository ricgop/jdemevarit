<?php 
  ...
  if ((isset($_GET['f1'])) || (isset($_GET['f2'])) || (isset($_GET['f3'])) || (isset($_GET['f4'])) || (isset($_GET['f5'])) || (isset($_GET['f6']))) {
    ...
    if (!isset($_SESSION['login_username'])) {
      if (isset($_POST['limitation1'])) $filter_submit_string .= '&f1=1';
      if (isset($_POST['limitation2'])) $filter_submit_string .= '&f2=1';
      if (isset($_POST['limitation3'])) $filter_submit_string .= '&f3=1';
      if (isset($_POST['limitation4'])) $filter_submit_string .= '&f4=1';
      if (isset($_POST['limitation5'])) $filter_submit_string .= '&f5=1';
      if (isset($_POST['limitation6'])) $filter_submit_string .= '&f6=1';
    }
  }
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><label><input type="checkbox" name="limitation1" <?php if(isset($_SESSION['login_username'])) {if($_SESSION['limitation1'] == 1 || isset($f1)) echo 'checked="checked"';} else {if(isset($_POST['limitation1']) || isset($f1)) echo 'checked="checked"';} ?>> Onemocnění žlučníku</label></li>
                  <li><label><input type="checkbox" name="limitation2" <?php if(isset($_SESSION['login_username'])) {if($_SESSION['limitation2'] == 1 || isset($f2)) echo 'checked="checked"';} else {if(isset($_POST['limitation2']) || isset($f2)) echo 'checked="checked"';} ?>> Onemocnění jater</label></li>
                  <li><label><input type="checkbox" name="limitation3" <?php if(isset($_SESSION['login_username']) || isset($f3)) {if($_SESSION['limitation3'] == 1 || isset($f3)) echo 'checked="checked"';} else {if(isset($_POST['limitation3'])) echo 'checked="checked"';} ?>> Alergie na pyl</label></li>
                  <li><label><input type="checkbox" name="limitation4" <?php if(isset($_SESSION['login_username']) || isset($f4)) {if($_SESSION['limitation4'] == 1 || isset($f4)) echo 'checked="checked"';} else {if(isset($_POST['limitation4'])) echo 'checked="checked"';} ?>> Alergie na ořechy</label></li>
                  <li><label><input type="checkbox" name="limitation5" <?php if(isset($_SESSION['login_username']) || isset($f5)) {if($_SESSION['limitation5'] == 1 || isset($f5)) echo 'checked="checked"';} else {if(isset($_POST['limitation5'])) echo 'checked="checked"';} ?>> Alergie na laktózu</label></li>
                  <li><label><input type="checkbox" name="limitation6" <?php if(isset($_SESSION['login_username']) || isset($f6)) {if($_SESSION['limitation6'] == 1 || isset($f6)) echo 'checked="checked"';} else {if(isset($_POST['limitation6'])) echo 'checked="checked"';} ?>> Celiakie</label></li>
      ...
      <div class="text-center" id = "bottom-navigation">
        <nav aria-label="Page navigation">
          <ul class="pagination">
            ...
            ?>
              <a href="<?php if ($page > 1) {echo'http://localhost/jdemevarit/recepty.php?page=' . ($page - 1) . $filter_string;}?>" aria-label="Previous">
            ...
            <?php
              ...
              if(isset($total_recipes)) {
                for ($i=1; $i < ($total_recipes/$paging + 1); $i++) {
                  # check if at least 1 filter is set in url
                  if ($filter_set == true) {
                  # highlight active page
                    if($page != ($i)) {
                      echo '<li><a href="http://localhost/jdemevarit/recepty.php?page=' . ($i) . $filter_string . '">' . $i . '</a></li>';
                    } else {
                      echo '<li><a href="http://localhost/jdemevarit/recepty.php?page=' . ($i) . $filter_string . '" id="active_page"><u><b>' . $i . '</b></u></a></li>';
                    }
                  #if filters are not set - don't do anything
                  } else {
                    # highlight active page
                    if($page != ($i)) {
              ...
              ?>
            <li>
              <a href="<?php if ($page < ($total_recipes/$paging)) {echo'http://localhost/jdemevarit/recepty.php?page=' . ($page + 1) . $filter_string;}?>" aria-label="Next">
